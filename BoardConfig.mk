...
DEVICE_PATH := device/samsung/kltechnduo
...
# Build Fingerprint
BUILD_FINGERPRINT := samsung/klteduoszn/klteduoszn:6.0.1/MMB29M/G9006WZNU1CPJ2:user/release-keys
...
# Init
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_kltechnduo
